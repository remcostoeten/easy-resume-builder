    ...
    <div className="max-w-4xl mx-auto p-8 space-y-8">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Your personal details and professional summary</p>
        </div>
      </div>
        ...
        <CardHeader className="pb-6">
          <div className="flex items-center justify-between">
            ...
            <Button variant="outline" size="sm" className="gap-2 bg-transparent">
              ...
              Upload Photo
              <span className="text-xs text-muted-foreground ml-1">JPG, PNG up to 2MB</span>
            </Button>
          </div>
        </CardHeader>
        ...
        <CardContent>
          <div className="space-y-6">
            ...
            <div className="text-center pt-4 border-t border-border">
              <p className="text-sm text-muted-foreground">✓ Changes are automatically saved as you type</p>
            </div>
          </div>
        </CardContent>
      </Card>
