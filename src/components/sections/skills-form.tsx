...
import type { TSkillCategory, TSkill } from "../../types/resume"
                        ...
                        onCheckedChange={(checked) =>
                          handleUpdateSkill(index, {
                            proficiency: {
                              ...
                              displayType: skill.proficiency?.displayType || "bar",
                            },
                          })
                        }
                      />
                      <Label htmlFor={`show-proficiency-${index}`} className="text-sm">
                      ...
                      <div className="space-y-4 pl-6 border-l-2 border-muted">
                        <div className="space-y-2">
                          ...
                          <Select
                            ...
                            onValueChange={(value: "bar" | "dots" | "text") =>
                              handleUpdateSkill(index, {
                                proficiency: {
                                  ...skill.proficiency!,
                                  displayType: value,
                          ...
                          >
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="text">Text Level</SelectItem>
                            </SelectContent>
                          </Select>
                        </div>
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center justify-between">
                            ...
                            <span className="text-sm text-muted-foreground">{skill.proficiency.level}/10</span>
                          </div>
                          <Slider
