...
import { Plus, Trash2, Calendar, Building, Save, X } from "lucide-react"
...
import { workItemSchema, type TWorkItemForm } from "../../schemas/resume-schemas"
...
export function WorkExperienceForm({ workItem, onSave, onCancel, onDelete }: TWorkExperienceFormProps) {
  const [achievements, setAchievements] = useState<string[]>(workItem?.achievements || [""])
  const [isCurrentPosition, setIsCurrentPosition] = useState(workItem?.dateRange.isCurrentPosition || false)
          ...
          <div className="space-y-4 p-4 border border-border rounded-lg bg-muted/20">
            ...
            <div className="space-y-4">
              <div>
                ...
                <Select
                  value={dateFormat}
                  onValueChange={(value: "year" | "month-year" | "full-date") => setDateFormat(value)}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
              ...
              <FormGrid columns={2}>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder={dateFormat === "month-year" ? "2023-01" : "2023"}
                ...
                {!isCurrentPosition && (
                  <div className="space-y-2">
                    ...
                    <Input
                      type={dateFormat === "month-year" ? "month" : "number"}
                      placeholder={dateFormat === "month-year" ? "2024-01" : "2024"}
          ...
          <div className="space-y-4">
            ...
            {achievements.length === 0 && (
              <p className="text-sm text-muted-foreground italic text-center py-4 border border-dashed border-border rounded-lg">
                No achievements added yet. Click "Add Achievement" to showcase your impact.
              </p>
            )}
          </div>

          <div className="flex justify-end pt-6 border-t border-border">
            <Button type="submit" className="px-8 bg-primary hover:bg-primary/90 text-primary-foreground gap-2">
