...
import { FolderOpen, Plus, Save, X, ExternalLink, Calendar, Code } from "lucide-react"
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Showcase your personal projects, side work, and portfolio pieces</p>
          </div>
        </div>
      ...
      {!isAddingNew && projects.length > 0 && (
        <div className="space-y-4">
          {projects.map((project) => (
            <Card key={project.id} className="border-border bg-card hover:bg-accent/50 transition-colors">
