...
import { Download, Eye, Edit, Split, Sun, Moon, EyeOff } from "lucide-react"
import { useState } from "react"

export type TProfessionalHeaderProps = {
    ...
    <header className="border-b bg-card px-6 py-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button className="bg-primary hover:bg-primary/90 text-primary-foreground" onClick={onDownload}>
