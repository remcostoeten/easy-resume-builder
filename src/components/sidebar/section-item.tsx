...
export function SectionItem({ section, onToggle, isDragging, dragHandleProps }: TSectionItemProps) {
        ...
        <div className="flex-1 min-w-0">
          <Label
            ...
            className={cn(
              ...
              section.isRequired && "after:content-['*'] after:ml-1 after:text-destructive",
            )}
          >
            {section.title}
          </Label>
