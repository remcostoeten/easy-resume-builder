...
export type TModernSectionsPanelProps = {
      ...
      >
        <GradientCard
          className={cn(
            ...
            isActive && "ring-2 ring-purple-500/50 bg-gradient-to-br from-purple-500/20 to-blue-500/20",
            ...
            <div className="flex items-center gap-2 flex-1 min-w-0">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  {section.isRequired && (
                    <span className="text-xs bg-orange-500/20 text-orange-400 px-2 py-0.5 rounded-full">Required</span>
                  )}
                </div>
