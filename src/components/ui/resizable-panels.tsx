...
const ResizablePanel = React.forwardRef<React.ElementRef<typeof Panel>, React.ComponentPropsWithoutRef<typeof Panel>>(
  ({ className, ...props }, ref) => <Panel ref={ref} className={cn("", className)} {...props} />,
)
