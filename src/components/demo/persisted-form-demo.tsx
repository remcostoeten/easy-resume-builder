			...
			<div className='bg-white rounded-lg border p-6 space-y-4'>
				...
				<div className='pt-4 border-t'>
					<p className='text-sm text-gray-500'>
						💡 <strong>Tip:</strong> Your input is automatically saved to localStorage
						as you type. Try refreshing the page to see it persist!
					</p>
				</div>
			</div>
			...
			<div className='bg-blue-50 rounded-lg border border-blue-200 p-6 space-y-4'>
				...
				<div className='pt-4 border-t border-blue-200'>
					<p className='text-sm text-blue-600'>
						⚡ <strong>Immediate Save:</strong> These fields save immediately without
						debouncing.
					</p>
				</div>
			</div>
