    ...
    <div className="h-full flex flex-col">
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <div>
            <h1 className="text-2xl font-bold text-white">{currentSection?.title || "Resume Builder"}</h1>
              ...
              {enabledSections.map((_, index) => (
                <motion.div
                  ...
                  className={`w-2 h-2 rounded-full cursor-pointer transition-all duration-200 ${
                    index <= currentStepIndex ? "bg-gradient-to-r from-blue-500 to-purple-500" : "bg-muted/30"
                  }`}
