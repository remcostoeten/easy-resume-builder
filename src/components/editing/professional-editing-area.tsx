...
export function ProfessionalEditingArea({ sections, resumeData }: TProfessionalEditingAreaProps) {
  ...
  // Set initial active section when enabled sections change
  useEffect(() => {
    ...
    return (
      <div className="h-full flex items-center justify-center bg-background">
        <div className="text-center max-w-md p-8">
          ...
          <h2 className="text-xl font-semibold mb-2 text-foreground">No Sections Enabled</h2>
  ...
  return (
    <div className="h-full flex flex-col">
      <SectionTabs sections={enabledSections} activeSection={activeSection} onSectionChange={setActiveSection} />
