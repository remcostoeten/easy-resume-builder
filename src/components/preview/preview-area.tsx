...
import { Eye, Download, Printer, Maximize2 } from "lucide-react"
    ...
    <div className="h-full flex flex-col">
      <div className="border-b bg-card p-4">
        ...
        <div className="flex gap-2">
          ...
          <Button size="sm" variant="outline" onClick={handlePrint} className="flex items-center gap-1 bg-transparent">
      ...
      <div className="flex-1 overflow-auto p-4">
        <motion.div
          ...
          className={isFullscreen ? "fixed inset-0 z-50 bg-background p-8 overflow-auto" : ""}
        >
