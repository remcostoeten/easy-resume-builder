          ...
          >
            <div>
              ...
              {personalInfo.summary && (
                <p className="text-gray-600 mt-2 max-w-2xl mx-auto leading-relaxed">{personalInfo.summary}</p>
              )}
            </div>
          ...
          {enabledSections
            ...
            .map((section, index) => (
              <motion.section
                ...
                className="space-y-4"
              >
                <h2 className="text-xl font-semibold text-gray-900 border-b border-gray-200 pb-2">{section.title}</h2>
