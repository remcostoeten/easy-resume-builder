              ...
              <div className="text-center space-y-6">
                <div className="relative">
                  ...
                  <div className="relative">
                    <div className="p-4 rounded-full bg-destructive/10 border border-destructive/20 inline-block">
                      <svg className="h-12 w-12 text-destructive animate-pulse" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="space-y-4">
                  <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    >
                      <svg className="h-4 w-4 mr-2 group-hover:rotate-180 transition-transform duration-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    >
                      <svg className="h-4 w-4 mr-2 group-hover:rotate-12 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
