...
describe('WelcomeModal', () => {
	...
	describe('Accessibility', () => {
		...
		it('should have accessible title and description', () => {
			...
			expect(screen.getByText('Welcome to Resume Builder! 🚀')).toHaveAttribute(
				'id',
				'modal-title'
			);
			expect(screen.getByText(/Create professional, ATS-optimized resumes/)).toHaveAttribute(
				'id',
				'modal-description'
			);
		});
	...
	describe('Content Rendering', () => {
		...
		it('should render all tip items', () => {
			...
			expect(
				screen.getByText(/Start with personal info and work backwards/)
			).toBeInTheDocument();
			expect(
				screen.getByText(/Use action verbs and quantify achievements/)
			).toBeInTheDocument();
		...
		it('should display privacy and storage information', () => {
			...
			expect(
				screen.getByText(/Your data stays in memory during this session/)
			).toBeInTheDocument();
			expect(
				screen.getByText('No signup required to get started • Your privacy is protected')
			).toBeInTheDocument();
		});
	});
