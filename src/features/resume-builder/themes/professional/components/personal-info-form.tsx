...
export function PersonalInfoForm({ data }: TProps) {
	...
	useEffect(() => {
		console.log('PersonalInfoForm FormState:', {
			isDirty,
			isValid,
			errors,
			formValues,
				...
				<form onSubmit={handleFormSubmit} className='space-y-6'>
					...
					<div className='grid grid-cols-2 gap-6'>
						<FormField
							...
							onBlur={(e: React.FocusEvent<HTMLInputElement>) =>
								handleBlur('website', e.target.value)
							}
						...
						<FormField
							...
							onBlur={(e: React.FocusEvent<HTMLInputElement>) =>
								handleBlur('linkedin', e.target.value)
							}
					...
					<FormField
						...
						onBlur={(e: React.FocusEvent<HTMLTextAreaElement>) =>
							handleBlur('summary', e.target.value)
						}
