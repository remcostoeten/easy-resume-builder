	...
	function prefillDemoCV() {
		...
		const demoData = {
			personalInfo: {
				...
				summary: 'Experienced full-stack developer with 8+ years of experience building scalable web applications. Passionate about clean code, modern technologies, and delivering exceptional user experiences.',
			},
			workExperience: [
				{
					id: 'work-1',
					...
					description: 'Led development of multiple high-traffic web applications using React, Node.js, and cloud infrastructure. Collaborated with cross-functional teams to deliver products used by 100k+ users.',
					achievements: [
				...
				},
				{
					...
					description: 'Built responsive web applications using modern JavaScript frameworks. Worked closely with designers to implement pixel-perfect UI components.',
					achievements: [
			...
			<div className='flex items-center justify-between'>
				<div className='flex items-center gap-4'>
					...
					<div className='flex items-center gap-1'>
						<Button variant='ghost' size='sm' className='text-xs' onClick={prefillDemoCV}>
							Prefill Demo CV
						</Button>
