...
export function AnimatedCheckbox({ 
  ...
  return (
    ...
    >
      ...
      <div className="relative flex-shrink-0" style={{ width: 'var(--size)', height: 'var(--size)' }}>
        <div 
        ...
        >
          <div className="absolute inset-[1px] flex items-center justify-center">
            <svg 
              viewBox="0 0 24 24" 
              className={`w-3/4 h-3/4 fill-none stroke-2 stroke-linecap-round stroke-linejoin-round transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] ${
                isChecked 
                  ? 'scale-100 stroke-primary' 
                  : 'scale-90 stroke-primary'
              }`}
              style={{
                strokeDasharray: '20',
